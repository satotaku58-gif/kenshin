...
export default function PatientSearchDialog({
  ...
  const bgColor = themeColor === "emerald" ? "bg-emerald-600" : "bg-blue-600";
  const textColor = themeColor === "emerald" ? "text-emerald-600" : "text-blue-600";
  const hoverColor = themeColor === "emerald" ? "hover:bg-emerald-700" : "hover:bg-blue-700";
  const spinnerBorder = themeColor === "emerald" ? "border-t-emerald-600" : "border-t-blue-600";
  const monoColor = themeColor === "emerald" ? "text-emerald-600" : "text-blue-600";
